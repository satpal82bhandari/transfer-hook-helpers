...
// connect to the solana blockchain (localnet for this demo)
const connection = new Connection('http://127.0.0.1:8899', 'confirmed');




// load a keypair from the local filesystem with localnet SOL
...
console.log(`https://solana.fm/tx/${signature}?cluster=localnet-solana`);
console.log(`https://solana.fm/address/${mint.publicKey.toBase58()}?cluster=localnet-solana`);
